...
type Client interface {
	...
	Updateusername(ctx context.Context, req *user.UpdateusernameRequest, callOptions ...callopt.Option) (r *user.UpdateusernameResponse, err error)
}
...
func (p *kUserServiceClient) Updateusername(ctx context.Context, req *user.UpdateusernameRequest, callOptions ...callopt.Option) (r *user.UpdateusernameResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)

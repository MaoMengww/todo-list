...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"Updateusername": kitex.NewMethodInfo(
		...
		newUserServiceUpdateusernameArgs,
		newUserServiceUpdateusernameResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
}
...
func updateusernameHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*user.UserServiceUpdateusernameArgs)
	realResult := result.(*user.UserServiceUpdateusernameResult)
	success, err := handler.(user.UserService).Updateusername(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newUserServiceUpdateusernameArgs() interface{} {
	return user.NewUserServiceUpdateusernameArgs()
}

func newUserServiceUpdateusernameResult() interface{} {
	return user.NewUserServiceUpdateusernameResult()
}
...
func (p *kClient) Updateusername(ctx context.Context, req *user.UpdateusernameRequest) (r *user.UpdateusernameResponse, err error) {
	var _args user.UserServiceUpdateusernameArgs
	_args.Req = req
	var _result user.UserServiceUpdateusernameResult
